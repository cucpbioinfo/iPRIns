...
std::vector<Evidence> FilterBreakpoint::getResultWithOutOverlapped(std::vector<Evidence> *master, std::vector<Evidence> *slave)
{
    std::vector<Evidence> cache;
    for (auto n : *master)
    {
...
std::vector<Evidence> FilterBreakpoint::getResultRemoveOverlapped(std::vector<Evidence> *master, std::vector<Evidence> *slave)
{
    std::vector<Evidence> cache;
    for (auto n : *master)
    {
